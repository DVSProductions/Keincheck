...
internal static class ToolInvoker
{
    ...
    private static McpServer CreateParkedServer()
    {
        ...
        var transport = new StreamServerTransport(input, output, serverName: "avalonia-mcp-client-local", loggerFactory: null);

        var options = new ModelContextProtocol.Server.McpServerOptions
        {
            ServerInfo = new Implementation { Name = "AvaloniaMcp.Client", Version = "0.1.0" },
        };
