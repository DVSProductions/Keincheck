...
/// <summary>
/// The wire-protocol version handshake for the AvaloniaMcp broker IPC channel.
/// A client (an embedded AvaloniaMcp instance inside a host app) and the hub
...
public static class ProtocolVersion
{
    ...
    /// quickly reject a stream that is not an AvaloniaMcp broker channel.
    /// </summary>
