...
/// <c>%APPDATA%/Keincheck/known-clients.json</c>. It lets the hub launch or restart
...
public sealed class KnownClientStore
{
    ...
    /// <c>%APPDATA%/Keincheck/known-clients.json</c>, or a custom path for tests.
    ...
    /// <summary>The default per-user store location under %APPDATA%/Keincheck.</summary>
