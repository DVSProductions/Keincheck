...
/// <summary>
/// Entry point for the AvaloniaMcp hub daemon. Single-instance per user: if a hub is
...
public static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        if (!isFirst)
        {
            Console.Error.WriteLine("AvaloniaMcp hub is already running for this user.");
            return 0;
        }
